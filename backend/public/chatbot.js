...
(function (global) {
  ...
  function injectStyles(cfg, shadow) {
    ...
    var css = [
      ...
      "padding:18px 18px 16px;display:grid;grid-template-columns:auto minmax(0,1fr) auto;grid-template-rows:auto auto;column-gap:12px;row-gap:10px;align-items:start;",
      ...
      ".cb-header-info{flex:1;min-width:0;grid-column:2 / 4;grid-row:1;position:relative;z-index:1;padding-right:44px;}",
      ...
      ".cb-human-btn{grid-column:3;grid-row:2;justify-self:start;position:relative;z-index:1;}",
      ...
      "flex-shrink:0;backdrop-filter:blur(10px);transition:background var(--cb-tr-fast),transform var(--cb-tr-fast);margin-left:auto;grid-column:3;grid-row:1;justify-self:end;position:relative;z-index:1;}",
      ...
      ".cb-messages{flex:1;overflow-y:auto;padding:20px 20px 14px;",
      ...
      ".cb-msg-wrap{max-width:78%;display:flex;flex-direction:column;gap:6px;}",
      ...
      ".cb-header{padding:16px 14px 14px;column-gap:10px;row-gap:8px;}",
      ".cb-header-info{padding-right:40px;}",
      ".cb-new-btn{grid-column:2;grid-row:2;}",
      ".cb-human-btn{grid-column:3;grid-row:2;}",
      ".cb-header-btn{font-size:11px;padding:8px 10px;}",
      ".cb-messages{padding:16px 14px 12px;gap:16px;}",
      ".cb-msg-wrap{max-width:86%;}",
